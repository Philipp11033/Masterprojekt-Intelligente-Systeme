"""
Configurations file for the robot and the simulation.
"""
...
class ConfigSim:
    ...
    def __init__(self, robot_config: ConfigRobot):
        ...
        # the radius, in which the lida considers obstacles
        ...
        #important for the bahavior!!! best testet parameters for simulation: 0.5 4 3
